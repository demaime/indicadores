...
export default function ActividadEconomica() {
  ...
  const [mesSeleccionado, setMesSeleccionado] = useState("SEPTIEMBRE"); // Cambiar cada mes a mano porque se me rompió mucho al hacerlo automatico
          ...
          <div className="w-full h-3/5 flex">
            <div className="w-1/3 h-full flex items-center justify-center">
              <div className="w-64 h-64 rounded-full relative flex items-center justify-center">
                <CountUp
                  decimals="2"
                  className="text-yellow-300 text-6xl font-black"
                  duration={1}
