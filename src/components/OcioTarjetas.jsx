    ...
    <div className="w-full h-full bg-gray-300">
      <div className="w-full h-1/3 flex justify-evenly">
        <div className="w-48 h-48 flex items-center justify-center rounded-full border-8 border-blue-400 bg-blue-200 relative  ">
          ...
          <h1 className="bg-blue-400 text-xl font-bold absolute top-2 left-1/2 transform -translate-x-1/2 rounded-lg border-4 px-4 border-white text-white">
            Fiesta
          </h1>
        ...
        <div className="w-48 h-48 flex items-center justify-center rounded-full border-8 border-red-400 bg-red-200 relative flex items-center justify-center   ">
          ...
          <h1 className="bg-red-400 text-xl font-bold absolute top-2 left-1/2 transform -translate-x-1/2 rounded-lg border-4 px-4 border-white text-white">
            Combo
          </h1>
      ...
      <div className="w-full h-1/3 flex justify-evenly">
        ...
        <div className="w-48 h-48 flex items-center justify-center rounded-full border-8 border-yellow-400 bg-yellow-200 relative  ">
          ...
          <h1 className="bg-yellow-400 text-xl font-bold absolute bottom-2 left-1/2 transform -translate-x-1/2 rounded-lg border-4 px-4 border-white text-white">
            Cine
          </h1>
        ...
        <div className="w-48 h-48 flex items-center justify-start pl-2 rounded-full border-8 border-purple-400 bg-purple-200 relative  ">
          ...
          <h1 className="bg-purple-400 text-xl font-bold absolute top-2 left-1/2 transform -translate-x-1/2 rounded-lg border-4 px-4 border-white text-white">
            Teatro
          </h1>
      ...
      <div className="w-full h-1/3 flex justify-evenly">
        ...
        <div className="w-48 h-48 flex items-center justify-center rounded-full border-8 border-orange-400 bg-orange-200 relative  ">
          ...
          <h1 className="bg-orange-400 text-xl font-bold absolute bottom-2 left-1/2 transform -translate-x-1/2 rounded-lg border-4 px-4 border-white text-white">
            Libro
          </h1>
