...
export default function Industria() {
  ...
  const aperturaIntermensualPyme = {
    ...
    julio: {
      "textiles e indumentaria": -4,
      "alimentos y bebidas": -2.6,
      "madera y muebles": -1.5,
      "papel e impresiones": 0.2,
      "quimicos y plasticos": -2.2,
      "metal y maquinaria": -0.5,
    },
    agosto: {
      "textiles e indumentaria": -0.9,
      "alimentos y bebidas": 0.9,
      "madera y muebles": 4.3,
      "papel e impresiones": 4.2,
      "quimicos y plasticos": 2.1,
      "metal y maquinaria": 5.9,
    },
    septiembre: {
      "textiles e indumentaria": -0.8,
      "alimentos y bebidas": 1.9,
      "madera y muebles": 2.8,
      "papel e impresiones": 9.1,
    ...
    noviembre: {
      "textiles e indumentaria": 1.8,
      "alimentos y bebidas": 3.7,
      "madera y muebles": 6.1,
      "papel e impresiones": 1.5,
      "quimicos y plasticos": 7.8,
      "metal y maquinaria": 3.3,
    },
    diciembre: {
      "textiles e indumentaria": 4.1,
      "alimentos y bebidas": 4.3,
      "madera y muebles": 4.7,
      "papel e impresiones": 7.8,
      "quimicos y plasticos": 6.7,
  ...
  const aperturaInteranualPyme = {
    ...
    julio: {
      "textiles e indumentaria": -5.2,
      "alimentos y bebidas": -14.9,
      "madera y muebles": -16.9,
      "papel e impresiones": -26.9,
      "quimicos y plasticos": -27.5,
      "metal y maquinaria": -18.2,
    },
    agosto: {
      "textiles e indumentaria": -3.6,
      "alimentos y bebidas": -10.8,
      "madera y muebles": -1.1,
      "papel e impresiones": -21.1,
      "quimicos y plasticos": -15.5,
      "metal y maquinaria": -4.8,
    },
    septiembre: {
      "textiles e indumentaria": -7.3,
      "alimentos y bebidas": -8.3,
      "madera y muebles": -0.6,
      "papel e impresiones": -20.7,
    ...
    noviembre: {
      "textiles e indumentaria": 1.7,
      "alimentos y bebidas": -1.8,
      "madera y muebles": 6.4,
      "papel e impresiones": -22.1,
      "quimicos y plasticos": -0.9,
      "metal y maquinaria": -6.1,
    },
    diciembre: {
      "textiles e indumentaria": 12.4,
      "alimentos y bebidas": 4.8,
      "madera y muebles": 18.1,
      "papel e impresiones": 3.4,
      "quimicos y plasticos": 9.2,
      "metal y maquinaria": 5.2,
    },
  };
  ...
  const aperturaAcumuladaPyme = {
    ...
    julio: {
      "textiles e indumentaria": -3.3,
      "alimentos y bebidas": -17,
      "madera y muebles": -17.9,
      "papel e impresiones": -21.2,
      "quimicos y plasticos": -26.6,
      "metal y maquinaria": -21.3,
    },
    agosto: {
      "textiles e indumentaria": -3.7,
      "alimentos y bebidas": -16.4,
      "madera y muebles": -15.6,
      "papel e impresiones": -18.2,
      "quimicos y plasticos": -24.3,
      "metal y maquinaria": -19,
    },
    septiembre: {
      "textiles e indumentaria": -4.6,
      "alimentos y bebidas": -15.5,
      "madera y muebles": -13.3,
    ...
    diciembre: {
      ...
      "madera y muebles": -5.5,
      "papel e impresiones": -11.1,
      "quimicos y plasticos": -12.2,
      "metal y maquinaria": -9.4,
    },
  };
  ...
  const capacidadInstaladaPyme = {
    ...
    JULIO: {
      "Textiles e indumentaria": 60.9,
      "Alimentos y bebidas": 61.6,
      "Madera y muebles": 60.9,
      "Papel e impresiones": 62.8,
      "Químicos y plásticos": 60.5,
      "Metal, maquinaria y equipo, y material de transporte": 59.1,
      MANUFACTURERA: 59.7,
      PYME: 60.6,
    },
    AGOSTO: {
      ...
      "Madera y muebles": 61.1,
      "Papel e impresiones": 60.6,
      "Químicos y plásticos": 57.3,
      "Metal, maquinaria y equipo, y material de transporte": 60,
      MANUFACTURERA: 61.3,
      PYME: 60,
    },
    SEPTIEMBRE: {
      "Textiles e indumentaria": 54.6,
      "Alimentos y bebidas": 62.2,
      "Madera y muebles": 61.6,
    ...
    NOVIEMBRE: {
      "Textiles e indumentaria": 59.6,
      "Alimentos y bebidas": 65.6,
      "Madera y muebles": 62.7,
      "Papel e impresiones": 66.5,
      "Químicos y plásticos": 65,
      "Metal, maquinaria y equipo, y material de transporte": 60.9,
      MANUFACTURERA: 62.3,
      PYME: 63.1,
    },
    DICIEMBRE: {
      "Textiles e indumentaria": 59.6,
      "Alimentos y bebidas": 62.1,
      "Madera y muebles": 66.6,
      "Papel e impresiones": 64.2,
      "Químicos y plásticos": 62.9,
      "Metal, maquinaria y equipo, y material de transporte": 60.8,
      MANUFACTURERA: "-",
      PYME: 62,
    },
  };
  ...
  const capacidadInstaladaIndustria = {
    ...
    JULIO: {
      ...
      "Minerales no metálicos": 52.3,
      "Papel y cartón": 60.3,
      "Refinación de petróleo": 83.1,
      "Edición e impresión": 48.8,
      Tabaco: 47.9,
      Metálicas: 61.5,
      "Caucho y plástico": 44,
      Automotriz: 52.2,
      "Sustancias y productos químicos": 65.7,
      "Metalmecánica (sin automotriz)": 51.1,
      MANUFACTURERA: 59.7,
      PYME: 60.6,
    },
    AGOSTO: {
    ...
    OCTUBRE: {
      Textiles: 47.8,
      "Alimentos y bebidas": 69.5,
      "Minerales no metálicos": 63.1,
      "Papel y cartón": 72.9,
      "Refinación de petróleo": 81.5,
      "Edición e impresión": 57.8,
      Tabaco: 48.9,
      Metálicas: 68.9,
      "Caucho y plástico": 48.9,
      Automotriz: 61.2,
      "Sustancias y productos químicos": 63.5,
      "Metalmecánica (sin automotriz)": 50.7,
      MANUFACTURERA: 63.2,
      PYME: 62.3,
    },
    NOVIEMBRE: {
      Textiles: 48.2,
      "Alimentos y bebidas": 66.9,
      "Minerales no metálicos": 60.6,
      "Papel y cartón": 68.6,
      "Refinación de petróleo": 82.1,
      "Edición e impresión": 53.0,
      Tabaco: 47.6,
      Metálicas: 67.2,
      "Caucho y plástico": 46.8,
      Automotriz: 64.7,
      "Sustancias y productos químicos": 66.1,
      "Metalmecánica (sin automotriz)": 50.0,
      MANUFACTURERA: 62.3,
      PYME: 63.1,
    },
    DICIEMBRE: {
          ...
          <div className="w-full h-1/5 bg-gray-400 flex items-center justify-evenly relative">
            ...
            <div className="w-1/6 h-3/4 rounded-xl bg-yellow-100 flex flex-col text-white text-xs">
              ...
              <span className="w-full h-3/4 font-black flex items-center justify-center text-4xl text-gray-700">
                {dataPyme[mesSeleccionado].interanual} %
              </span>
            </div>
            <div className="w-1/6 h-3/4 rounded-xl bg-gray-200 flex flex-col text-white text-xs">
              ...
              <span className="w-full h-3/4 font-black flex items-center justify-center text-4xl text-gray-700">
                {dataPyme[mesSeleccionado].intermensual} %
              </span>
            </div>
            <div className="w-1/6 h-3/4 rounded-xl bg-gray-200 flex flex-col text-white text-xs">
              <span className="w-full h-1/4 bg-gray-700 flex items-center justify-center font-semibold">
        ...
        <div className="w-full h-[95%] flex">
          ...
          <div className="w-1/4 h-full bg-gray-700 flex flex-col items-center justify-evenly">
            ...
            <div className="rounded text-yellow-400 border-2 border-yellow-500 w-56 h-32 flex flex-col items-center justify-between">
              ...
              <p className="text-5xl pb-8">
                {variacionesManufacturera[mesSeleccionado].interanual} %
              </p>
            </div>{" "}
            <div className="rounded text-yellow-400 border-2 border-yellow-500 w-56 h-32 flex flex-col items-center justify-between">
              <span className="h-1/5 w-full bg-yellow-500 text-gray-700 text-center text-xs flex items-center justify-center font-bold">
              ...
              <p className="text-5xl pb-8">
                {variacionesManufacturera[mesSeleccionado].intermensual} %
              </p>
            </div>
          </div>
        </div>
