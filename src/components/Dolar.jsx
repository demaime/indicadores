...
export default function Dolar() {
      ...
      try {
        ...
        const promedios2024 = {
          ...
          noviembre: calcularPromedio(
            dataOficial2024.filter((cotizacion) =>
              cotizacion.fecha.startsWith("2024-11")
            )
          ),
          diciembre: calcularPromedio(
            dataOficial2024.filter((cotizacion) =>
              cotizacion.fecha.startsWith("2024-12")
            )
          ),
        };
        const promedios2023 = {
  ...
  const evolutivo = [
    ...
    {
      mes: "julio",
      oficial: promediosOficial2024.julio,
      mayorista: promediosMayorista2024.julio,
      blue: promediosBlue2024.julio,
      mep: promediosMep2024.julio,
    ...
    {
      mes: "septiembre",
      oficial: promediosOficial2024.septiembre,
      mayorista: promediosMayorista2024.septiembre,
      blue: promediosBlue2024.septiembre,
      mep: promediosMep2024.septiembre,
    ...
    {
      mes: "noviembre",
      oficial: promediosOficial2024.noviembre,
      mayorista: promediosMayorista2024.noviembre,
      blue: promediosBlue2024.noviembre,
      mep: promediosMep2024.noviembre,
      ccl: promediosCcl2024.noviembre,
      cripto: promediosCripto2024.noviembre,
      tarjeta: promediosTarjeta2024.noviembre,
    },
    {
      mes: "diciembre",
      oficial: promediosOficial2024.diciembre,
      mayorista: promediosMayorista2024.diciembre,
      blue: promediosBlue2024.diciembre,
      mep: promediosMep2024.diciembre,
      ccl: promediosCcl2024.diciembre,
      cripto: promediosCripto2024.diciembre,
      tarjeta: promediosTarjeta2024.diciembre,
    },
  ];
